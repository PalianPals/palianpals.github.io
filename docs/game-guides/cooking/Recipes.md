...
|![BlueberryPie](./img/BlueBerryPie.png)|Blueberry Pie| 225<br />![Star](./img/STAR2.png)337| XP |The recipe can be purchased from the Reth / Cooking Guild Store upon reaching Cooking Cooking Level 6, for ![GOLD](./img/GOLD.png) 1500 Gold.|
...
|![CelebrationCake](./img/CelebrationCake.png)|Celebration Cake| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |The recipe can be purchased from the Reth / Cooking Guild Store upon reaching Cooking Cooking Level 9, for ![GOLD](./img/GOLD.png) 3000 Gold.|
...
|![ChapaaMasala](./img/ChapaaMasala.png)|Chapaa Masala| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |The recipe can be purchased from the Reth / Cooking Guild Store upon reaching Cooking Cooking Level 8, for ![GOLD](./img/GOLD.png) 2500 Gold.|
...
|![ChiliOilDumplings](./img/ChiliOilDumplings.png)|Chili Oil Dumplings| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |The recipe can be purchased from the Reth / Cooking Guild Store upon reaching Cooking Cooking Level 9, for ![GOLD](./img/GOLD.png) 2500 Gold.|
...
|![CrabGumbo](./img/CrabGumbo.png)|Crab Gumbo| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP | The recipe can be obtained by reaching **Friendship level 3 💞 with Zeki** and completing the Quest ❗ **Magical Mystery Machine**. It can be found on a desk inside his room. | ![Location](./img/CrabGumboLOCATION.png)|
|![CrabPotPie](./img/CrabPotPie.png)|Crab Pot Pie| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |The recipe can be purchased from the Reth / Cooking Guild Store upon reaching Cooking Cooking Level 5, for ![GOLD](./img/GOLD.png) 1000 Gold.|
|![CreamofMushroomsoup](./img/CreamofMushroomsoup.png)|Cream of Mushroom Soup| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |The recipe can be obtained by reaching **Friendship level 3 💞 with Hekla** and gaining access to Hekla's Tent during the Quest ❗ **Potato Shrine** quest. It can be found inside of the tent. <br /> The recipe can also be obtained during the **Friendship level 4 💞 Quest ❗ Cheer Up for Jina**. It is given to you by Hekla. | ![Location](./img/CreamofMushroomSoupLOCATION.png)|
|![CreamOfTOmatoSoup](./img/CreamOfTOmatoSoup.png)|Cream of Tomato Soup| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |The recipe can be obtained by reaching **Friendship level 3 💞 with Reth** and gaining access to his storeroom during the ❗ **Piece of Cake quest**. The storeroom is located under the inn. The recipe is on your right after you've entered the room. | ![Location](./img/CreamofTomatoSoupLOCATION.png)|
|![CreamyCarrotSoup](./img/CreamyCarrotSoup.png)|Creamy Carrot Soup| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP | The recipe can be obtained **after** completing the Friendship level 1 💞 quest ❗ **Manners, Manners** for Caleri, and receiving a library card in the mail
The **green** book is located on an upper shelf in the nook to the right of the Library, often occupied by Kenyatta. | ![Location](./img/CreamyCarrotSoupLOCATION.png)|
|![ElderwoodPie](./img/ElderwoodPie.png)|Elderwood Pie| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP | The recipe can be obtained by completing the quest ❗ **Little Bumble's Pie **.|
|![FishermansBrew](./img/FishermansBrew.png)|Fishermans Brew| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |The recipe can be purchased from Einar / the Fishing Guild Store upon reaching Fishing Fishing Level 5, ![GOLD](./img/GOLD.png) 1000 Gold.|
|![FishStew](./img/FishStew.png)|Fish Stew| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |The recipe can be obtained by fishing from **Bahari Coast** using a **Worm**. It is a Rare item and looks like a message in a bottle when hooked. | 
|![FishTacos](./img/FishTacos.png)|Fish Tacos| FOCUS <br />![Star](./img/STAR2.png) FOCUS|XP |The recipe can be purchased from the Reth / Cooking Guild Store upon reaching Cooking Cooking Level 3, for ![GOLD](./img/GOLD.png) 200 Gold.|
|![FlowtatoFriesWithKetchup](./img/FlowtatoFriesWithKetchup.png)|Flowtato Fries With Ketchup| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP | The recipe can be obtained by looting a Treasure Chest in the Elderwood. The treasure chest can be found in the Deep Woods, behind some purple boxes. Against the wall between the entrance to the Central Stables and Lilac Cavern. | ![Location](./img/FlowtatoFrieswithKetchupLOCATION.png)|
|![FriedCatfish](./img/FriedCatfish.png)|Fried Catfish Dinner | FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |The recipe can be obtained by reaching Friendship level 3 💞 with Hassian, and gaining access to his grove after completing the quest ❗ **Room for Improvement**. It is a blue book located in the middle of the grove, on his sleeping bag near a campfire. | ![Location](./img/FriedCatfishDinnerLOCATION.png)|
...
|![GrilledOyster](./img/GrilledOyster.png)|Grilled Oyster| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |OBTAIN |LOCATION|
...
|![Macaron](./img/Macaron.png)|Macarons| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |OBTAIN |LOCATION|
...
|![PanFriedDumplings](./img/PanFriedDumplings.png)|Pan Fried Dumplings| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |OBTAIN |LOCATION|
...
|![QuicheCaleri](./img/QuicheCaleri.png)|Quiche Caleri| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |OBTAIN |LOCATION|
...
|![SoonTofu](./img/SoonTofu.png)|Soon Tofu| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP |OBTAIN |LOCATION|
