...
|![CreamyCarrotSoup](./img/CreamyCarrotSoup.png)|Creamy Carrot Soup| FOCUS <br />![Star](./img/STAR2.png) FOCUS| XP | The recipe can be obtained **after** completing the Friendship level 1 💞 quest ❗ **Manners, Manners** for Caleri, and receiving a library card in the mail. The **green** book is located on an upper shelf in the nook to the right of the Library, often occupied by Kenyatta. | ![Location](./img/CreamyCarrotSoupLOCATION.png)|
